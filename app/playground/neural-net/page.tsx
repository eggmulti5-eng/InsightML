...
export default function NeuralNetPage() {
  return (
    <main className="min-h-screen bg-[#1e140e] text-[#fefae0] p-8 flex flex-col items-center justify-center font-vt323">
      <div className="border-4 border-[#bc4749] bg-[#281b12] p-8 shadow-[6px_6px_0px_0px_#0f0a07] max-w-md text-center">
        <h1 className="text-2xl font-pixel text-[#bc4749] mb-4 uppercase tracking-wider">
