...
export default function NeuralNetPage() {
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100 p-8 flex flex-col items-center justify-center font-mono">
      <div className="border-4 border-purple-500 bg-zinc-900 p-8 shadow-[6px_6px_0px_0px_rgba(168,85,247,1)] max-w-md text-center">
        <h1 className="text-3xl font-extrabold text-purple-400 mb-4 uppercase tracking-wider">
          Multi-Layer Neural Net
        </h1>
        <p className="text-zinc-400 mb-6 text-sm">
          [MODULE COMING SOON] Interactive backpropagation and non-linear decision boundary visualizer!
        </p>
        <Link
